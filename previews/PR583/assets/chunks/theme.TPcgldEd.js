...
const _sfc_main$q = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.C-c-yUwk.js"), true ? __vite__mapDeps([0,1]) : void 0));
